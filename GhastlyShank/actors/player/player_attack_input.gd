...
var _moveDir:Control
var _lookDir:Control
...
var mouseDelta:Vector3 = Vector3()

func _ready():
	_moveDir = get_parent().get_node_or_null("hud/crosshair/move_direction")
	_lookDir = get_parent().get_node_or_null("hud/crosshair/look_direction")
